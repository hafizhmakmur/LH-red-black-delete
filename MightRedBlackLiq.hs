...
{-{-@ balance :: c:Color 
            ...
            -> {r:RBSR a x | ((prop_IM l && prop_CT r) ||
                              (prop_CT l && prop_IM r)) 
                          && (blackHeightL l == blackHeightL r) } 
            -> {v:RBSet a | ((c /= B && c /= BB && prop_IM v) || prop_CT v) 
...
{-@ balance :: c:Color
            ...
            -> {r:RBSR a x | ((prop_IM l && prop_CT r) ||
                              ...
                              (prop_CT l && prop_CT r)) 
                          && (blackHeightL l == blackHeightL r) } 
            -> {v:RBSet a | ((prop_IM l && prop_CT r && prop_CT v) ||
                             (prop_CT l && prop_IM r && prop_CT v) ||                             
                             (c /= B && prop_CT l && prop_CT r && prop_IM v) ||
                             (prop_CT l && prop_CT r && prop_CT v)) 
                         && (blackHeightL v == (blackHeightL l + colorValue c))} 
@-}
...
--{-@ removeMax :: {x:CT a | not normalLeaf x} -> IM {w : a | w < max' x} @-}
