...
prop_BST' (T _ l@(T _ _ xl _) x r@(T _ _ xr _)) = (xl < x) && (x < xr)
                                               && prop_BST' l 
                                               && prop_BST' r
...
prop_BST' (T _ l x r@(T _ _ xr _)) = (x < xr)
                                  && prop_BST' l
                                  && prop_BST' r
prop_BST' (T _ l x r) = prop_BST' l && prop_BST' r --Why the **** do I need these
prop_BST' _ = True 
...
{-@ prop_Rb2 :: x:RT Int -> {v:Bool | blackRoot x} @-}
prop_Rb2 :: RBSet Int -> Bool
prop_Rb2 t = color t == B

{-@ prop_Rb3 :: x:RT Int -> {v:Bool | validBlackHeight x} @-}
...
{-@ prop_Rb4 :: x:RT Int -> {v:Bool | redChildIsBlack x} @-}
